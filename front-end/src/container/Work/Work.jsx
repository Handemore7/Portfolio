    ...
    <>
      ...
      <div className='app__work-filter'>
        {['UI/UX', 'Web App', 'Mobile App', 'React js', 'All'].map((item, i) => (
          <div key={i} onClick={() => handleWorkFilter(item)} className={`app__work-filter-item app__flex ${activeFilter === item ? 'item-active': ''}`}>
            {item}
          </div>
        ))}
      </div>
            ...
            <div className='app__work-item app__flex' key={index}>
              ...
              <div className='app__work-content app__flex'>
                ...
                <div className='app__work-tag app__flex'>
                  <p className='p-text'>{work.tags ? work.tags[0] : 'No tag provided'}</p>
                </div>
              </div>
            </div>
          ))} 
